...
class DataTransformationConfig:
     def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transformed_train_file_path: str = os.path.join( self.data_transformation_dir,constants.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
            constants.TRAIN_FILE_NAME.replace("csv", "npy"),)
        self.transformed_test_file_path: str = os.path.join(self.data_transformation_dir,  constants.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.trained_model_file_path: str = os.path.join(
            self.model_trainer_dir, constants.MODEL_TRAINER_TRAINED_MODEL_DIR, 
